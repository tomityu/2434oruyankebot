...
channels = {
    ...
    'UC0g1AE0DOjBYnLhkgoRWN1w': {'name': '本間ひまわり🌻', 'tag': '#ひまなま', 'region': Region.JPN},
    ...
    'UCIeSUTOTkF9Hs7q3SGcO-Ow': {'name': 'Elira Pendora🌤', 'tag': '#PenCast', 'region': Region.ENG},
    'UCP4nMSTdwU1KqYWu3UH5DHQ': {'name': 'Pomu Rainpuff🧚🍂', 'tag': '#PomuLive', 'region': Region.ENG},
    'UCu-J8uIXuLZh16gG-cT1naw': {'name': 'Finana Ryugu🐠', 'tag': '#FinanaLive', 'region': Region.ENG},
    ...
    'UCIJ9zP6gIkT8BB4Lz4UYPhA': {'name': '유루리/Yu Ruri🎀🧸', 'tag': '#ruri_live', 'region': Region.KOR},
    'UCjGE11ZnF0JSR8egVAwh-3A': {'name': '신유야/Shin Yuya🌙', 'tag': '#yuyair', 'region': Region.KOR},
    'UCUtKkGKef8BYMs3h-3zQm9A': {'name': '민수하/Min Suha🌊', 'tag': '#suha_live', 'region': Region.KOR},
    ...
    'UCJ6LH4jMNy0JN9RSThz1mMQ': {'name': '🌑한치호/Han Chiho🦋', 'tag': '#ChihoLive', 'region': Region.KOR},
    ...
    'UCmWqYB6y8gSfPONWGspuOWQ': {'name': '채아라/Chae Ara🌹💛', 'tag': '#Ara_Live', 'region': Region.KOR},
    'UCSlv7Z-4q7_7NRkzJB10A5Q': {'name': '이시우/Lee Siu🐾', 'tag': '#SIU_SeeU', 'region': Region.KOR},
    'UC5ek2GWKvUKFgnKSHuuCFrw': {'name': '소나기/So Nagi🌧️', 'tag': '#nagilive', 'region': Region.KOR},
    ...
    'UCClwIqTUn5LDpFucHyaAhHg': {'name': '이로하/Lee Roha🔰', 'tag': '#Roha_Live', 'region': Region.KOR},
